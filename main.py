...
print(Fore.GREEN + "ZWeeksAMZ Made By ZeDeen")
print(Fore.RED + "Gen Card Amazon")
print("[1]. 1k Card")
print("[2]. 2k Card")
print("[3]. 5k Card")
print("[4]. 10k Card")
print(" ")
whatcard = input("Root@ZeDeen/ (1, 2, 3 or 4) ")
print(" ")
whatcard = int(whatcard)
randomnums = "0123456789"

if whatcard == 1:
    howmany = input("Root@ZeDeen/[?] How Many Cards Do You Want? ")
    time.sleep(0.8)
    print("[/] Starting")
    time.sleep(0.8)
    howmany = int(howmany)
